...
/**
 * Author: cpetit. from neo9 TODO analyse and refactor
 */

/**
 * A util class that defines some convenience methods in order to declare instances of {@code BeanMappingBuilder}.
 * Note: all bean mapping builders instantiated by this class are bi directional (they can be use in both ways)
 */
@Getter
